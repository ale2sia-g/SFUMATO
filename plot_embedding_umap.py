#!/usr/bin/env python3
"""Plot UMAP representations from a preprocessing cache and BGM bin CSVs."""
...
from utils_bgm import BGMConfig, bgm_stem_for, cache_file_for, image_dir_for, result_dir_for
...
def plot_for_k(
    ...
    save_scatter(image_dir / f"{stem}_umap_plain.png", emb2d, title=f"{stem}: UMAP", point_size=point_size)
...
def main() -> None:
    ...
    for k in k_values:
        plot_for_k(cfg, int(k), X_norm, good_bin_ids, pos, umap_settings)
